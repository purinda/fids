			...
			case mTCPState of
				...
				tsWaitIPSeek:
					begin
						...
						if (oUDPserver <> nil) and (oUDPserver.ServerName <> '')
						  and (oUDPserver.ServerName = mTCPServerName) then
						begin
							if oTCP.InitConnection(oUDPserver.ServerIP,
							  ctClient) then
								SetNewState(tsPassThrough)
							else
				...
				tsWaitServerList:
					begin
						...
						begin
							...
							begin
								if oTCP.InitConnection(mServerIPs[x],
								  ctClient) then
								begin
									SetNewState(tsPassThrough);
									con := true;
