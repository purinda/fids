...
// escapes tag content
function BracketATag(n: string; kind: aTagType = ttStart; indent: int = 0)
...
function FormatADataRequest(ed: boolean; const req: string; const id: string;
  const name: string; path: string): string; overload;
// makes a request from a path list
...
function FormatADataRequest(ed: boolean; const req: string; const id: string;
  const name: string; path: string): string;
