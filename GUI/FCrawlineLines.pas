...
begin
  ...
  begin
    ...
    frame := DB().GetNode(fidsDisplayConfigPath).SubNodes.Items[I];
    ...
    begin
      page := DB().GetNode(fidsDisplayConfigPath + '|' + frame.NodeName +
        '|Devices').SubNodes.Items[J];
  ...
  begin
    ...
    begin
      Req := FormatEditRequest(CurrentNodeData.DBPath + 'Location|',
        FCrawlingLineEdit.cmbLocation.Text, CurrentNodeData.Location, 'Feed');
      DB.BroadcastRequest(Req);
    end;
    ...
    begin
      Req := FormatEditRequest(CurrentNodeData.DBPath + 'Blinking|',
        FCrawlingLineEdit.cmbBlinking.Text, CurrentNodeData.Blinking, 'Feed');
      DB.BroadcastRequest(Req);
    end;
    ...
    begin
      Req := FormatEditRequest(CurrentNodeData.DBPath + 'Crawling|',
        FCrawlingLineEdit.cmbCrawling.Text, CurrentNodeData.Crawling, 'Feed');
      DB.BroadcastRequest(Req);
    end;
