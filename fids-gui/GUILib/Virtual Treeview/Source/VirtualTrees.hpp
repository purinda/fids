...
// (DO NOT EDIT: machine generated header) 'Virtualtrees.pas' rev: 20.00
...
typedef Set<Virtualtrees__61, tsCancelHintAnimation, tsWindowCreating>  TVirtualTreeStates;
...
private:
	TBaseVirtualTree* FOwner;
	StaticArray<Graphics::TColor, 15> FColors;
...
typedef void __fastcall (__closure *TVTMeasureTextWidthEvent)(TBaseVirtualTree* Sender, Graphics::TCanvas* TargetCanvas, PVirtualNode Node, TColumnIndex Column, const System::UnicodeString Text, int &Width);
...
protected:
	...
	virtual int __fastcall DoTextMeasuring(Graphics::TCanvas* Canvas, PVirtualNode Node, TColumnIndex Column, System::UnicodeString Text);
	virtual TTreeOptionsClass __fastcall GetOptionsClass(void);
...
public:
	...
	System::AnsiString __fastcall ContentToText(TVSTTextSourceType Source, char Separator)/* overload */;
...
#define DefaultPaintOptions (Set<TVTPaintOption, toHideFocusRect, toUseExplorerTheme> () << toShowButtons << toShowDropmark << toShowRoot << toShowTreeLines << toThemeAware << toUseBlendedImages )
...
#define DefaultMiscOptions (Set<TVTMiscOption, toAcceptOLEDrop, toEditOnDblClick> () << toAcceptOLEDrop << toFullRepaintOnResize << toInitOnSave << toToggleOnDblClick << toWheelPanning << toEditOnClick )
...
extern PACKAGE void __fastcall DrawTextW(HDC DC, System::WideChar * lpString, int nCount, Types::TRect &lpRect, unsigned uFormat, bool AdjustRight);
