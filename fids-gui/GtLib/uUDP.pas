...
type
    ...
    cUDP = class( TIdUDPServer )   // based on indy UDP transciever
        private
            ...
            procedure  UDPReadEvent( AThread: TIdUDPListenerThread; AData: array of Byte; ABinding: TIdSocketHandle);
            {$ELSE }
...
{$IFDEF VER240 }
procedure  cUDP.UDPReadEvent( AThread: TIdUDPListenerThread; AData: array of Byte; ABinding: TIdSocketHandle);
{$ELSE }
