...
const
	...
	TagScan			= 'ReqScan';
		//<ReqScan>  path    dumb scan of whole branch
	TagSearch		= 'ReqSearch';     //  base path;  interesting subtags<=>value;
		//<ReqSearch>  path\name\content    multi level search

	// TagEditRequest
	TagRenameTag	= 'ReqRenameTag';  // new name
	TagDelete		= 'ReqDelete';   // <tag> \name\content
	TagNewTag		= 'ReqNewTag';   // <tag> \name\content  <newsubs>.... />
	TagEdit			= 'ReqEdit';     // <tag> oldcontent\newcontent\
	...
	// User IDs     typically ( server number ) * 100 + NextID()
    ...
    EOL = #13 + #10;
	SeparatorList = '\';                   // SPECIAL AS CHARS in XML content
...
const                      // error severity and id
	...
	erWarning = 100;
        ...
        erInvalidFeedField = 111;
		erRenToNonuniqueKeyNode = 112;
