...
begin
	...
	begin
		...
		frmWindows[6].SetController('Timetable Arrivals - ' + Caption,
		  fkArrivals, uCommon.TArrivalFields, uCommon.TArrivalColumns);
		frmWindows[6].Show;
	end;
end;
...
begin
	...
	if MessageDlg('Close FIDS GUI?', mtconfirmation, [mbNo, mbYes], 0, mbNo)
	  = mrYes then
	begin
		CanClose := True;
